...
modelNames[0]="roborock.vacuum.s6"
modelNames[1]="roborock.vacuum.s6v2"
modelNames[2]="roborock.vacuum.s6v3"

case ${model} in 
	"v1")
		modelName=${modelNames[0]}
		modelValue="MiJiaConstants.MODEL_V1"
		applicationId="com.roborock.tanos.s6.app";;
	"v2")
		modelName=${modelNames[1]}
		modelValue="MiJiaConstants.MODEL_V2"
		applicationId="com.roborock.tanos.s6.android_test";;
	"v3")
		modelName=${modelNames[2]}
		modelValue="MiJiaConstants.MODEL_V3"
		applicationId="com.roborock.tanos.s6.android_inner_test";;
	*) 
		echo "错误的model -- ${model}";
		exit 11;;
esac
