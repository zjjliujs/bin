...
if [ $# -lt 2 ] 
then
	echo "tanos_v_prepare.sh <v1|v2|v3> <versionCode>"
	exit 10
fi
...
modelNames[0]="roborock.vacuum.v8"
modelNames[1]="roborock.vacuum.v8v2"
modelNames[2]="roborock.vacuum.v8v3"

case ${model} in 
	"v1")
		modelName=${modelNames[0]}
		modelValue="MiJiaConstants.MODEL_V1"
		applicationId="com.roborock.tanos_v.app";;
	"v2")
		modelName=${modelNames[1]}
		modelValue="MiJiaConstants.MODEL_V2"
		applicationId="com.roborock.tanos_v.android_test";;
	"v3")
		modelName=${modelNames[2]}
		modelValue="MiJiaConstants.MODEL_V3"
		applicationId="com.roborock.tanos_v.android_inner_test";;
	*) 
		echo "错误的model -- ${model}";
		exit 11;;
esac
